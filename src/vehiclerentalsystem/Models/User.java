...
public class User {
    ...
    // Where are going to create three constructores one for registration(with
    // password), the other for login(without password)
    // for the last one it will be for DAO to have an internall manuplation of the
    // database.
    ...
    public User(int id, String username, String email, String password, String firstName,
            String lastName, int roleID, boolean isActive) {
        this.id = id;
        this.username = username;
        this.email = email;
        this.password = password;
    ...
    // Creating the toSafeUser, it's a way to create a safe copy of the current
    // user.
