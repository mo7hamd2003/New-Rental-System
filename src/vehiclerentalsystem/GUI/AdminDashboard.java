...
public class AdminDashboard extends javax.swing.JFrame {
	...
	public AdminDashboard(User user) {
		...
		setupBookingTable(); // Initialize table before initComponents
		initComponents();
	...
	private void initComponents() {
		...
		jLabel21.setText("Recent Activity - Customer Bookings");
		...
		jPanel9.add(javax.swing.Box.createRigidArea(new java.awt.Dimension(0, 10)));

		// Create scroll pane for the booking table
		javax.swing.JScrollPane bookingScrollPane = new javax.swing.JScrollPane(bookingTable);
		bookingScrollPane.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED);
		bookingScrollPane.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		bookingScrollPane.setPreferredSize(new java.awt.Dimension(800, 150));
		bookingScrollPane.setMaximumSize(new java.awt.Dimension(Integer.MAX_VALUE, 150));

		jPanel9.add(bookingScrollPane);
